...
<body>
	...
	<div class="container my-5">
		<form method="POST">
  			...
  			<div class="form-control">
    			<label>Mobile</label>
   				<input type="text" class="form-control" placeholder="Enter your mobile number" name="mobile" autocomplete="off"<?php echo $mobile ?>>

  			</div>
  			<div class="form-control">
    			<label>Password</label>
   				<input type="text" class="form-control" placeholder="Enter your password" name="password" autocomplete="off"<?php echo $password ?>>
